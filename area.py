...
class RectArea(Area):
    ...
    def check_collision(self, pos):
        return pos[0] >= self.pos[0] and pos[0] <= self.pos[0] + self.size[0] and pos[1] >= self.pos[1] and pos[1] <= \
    ...
    def render(self, screen, offset=(0, 0), scale=1, render_path=False):
        rect = pygame.Rect(((self.pos[0] - offset[0]) * scale, (self.pos[1] - offset[1]) * scale),
...
class CircleArea(Area):
    ...
    def render(self, screen, offset=(0, 0), scale=1, render_path=False):
        pygame.draw.circle(screen, self.color,
                           ((self.center[0] - offset[0]) * scale, (self.center[1] - offset[1]) * scale),
                           self.radius * scale)
